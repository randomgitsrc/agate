...
| TAG0002 | 重构一等任务（Phase A：change_type: refactor + P6 重构验收口径 + gate 分流） | 🔄 | P0 | 高 | — | 2026-08-12 | 2026-08-12 |
| TAG0003 | agate 工作区架构（agate-workspace/ 目录规范 + roadmap 任务管理循环 + .agate.env 配置 + docs/tasks 迁移工具） | 🔄 | P0 | 高 | — | 2026-08-12 | 2026-08-12 |
