...
|------|----------|------|------|--------|------|----------|----------|
| TAG0020 | 独立 Judge 机制（RM-AG0032）：P6.5 验收独立裁判（judge 角色 fresh context 信息隔离 + 三层防造假 + append-only 事件账本 + 三档预算）；TAG0018 实证 LLM 评审≈0 净收益为立项锚 | 🔄 | P7 | 高 | TAG0019 | 2026-08-21 | 2026-08-22 |
