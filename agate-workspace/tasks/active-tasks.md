...
| TAG0031 | DEBT 存量修复批（DEBT0002/3/4/7/16/17/18）：版本管理域（hash 双实现合并+manifest 信任边界+卸载扫描限流 WARNING）+ 测试隔离（check_pruning 临时 git 仓库）+ check-gate.py 健壮性（resolve_workspace 权威解析/核对表整行判定/fail-closed 降级）——低风险脚本修复，仿 TAG0024 工具链批先例 | 🔄 | P2 | 低 | — | 2026-09-03 | 2026-09-04 |
