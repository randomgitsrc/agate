...
|------|----------|------|------|--------|------|----------|----------|
| TAG0021 | 协议结构化层（RM-AG0022）：rules/{phases,dispatch,roles}.yaml + JSON Schema + S-1~S-6 双向一致性 gate + gate 脚本从 grep markdown 迁移读 YAML（M0-M3 渐进）；RM-0031 写时校验与 RM-0036 双语锚点的地基 | 🔄 | P1 | 高 | — | 2026-08-21 | 2026-08-22 |
