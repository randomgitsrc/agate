...
|------|----------|------|------|--------|------|----------|----------|
| TAG0008 | agate 版本管理机制（v1）：多版本共存 + 项目锁定 + 程序化安装/升级（agate-install / agate-resolve / hook 解析入口 / summary 版本显示）——P0-brief 已更新至 Python 化后状态（2026-08-15）| 🔄 | P7 | 高 | — | 2026-08-13 | 2026-08-16 |
