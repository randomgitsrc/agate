...
|------|----------|------|------|--------|------|----------|----------|
| TAG0023 | 机制校验补强批（RM-AG0042 retries 强制记录 + RM-AG0043 roadmap 回写校验 + RM-AG0044 环境敏感测试治理 + RM-AG0045 声明写时校验）：TAG0019-21 复盘独立评审确认的 4 个 agate 机制缺口合并处理 | 🔄 | P2 | 高 | — | 2026-08-23 | 2026-08-24 |
