...
| TAG0030 | 验收盲区机制批（RM-AG0057 四类 + DEBT0024/25/26）：测试副作用/环境还原 gate（创建型 E2E 清理钩子）+ P1 人工体验路径验收节（seed 后页面有内容 BDD）+ plan-design-review 形态驱动化（读 ui_render_shape 加载维度组）+ 布局方案 ≥2 候选下沉 UI 层 + 视觉契约断言（DOM 度量）+ TAG0027 复盘三连（真实 gate 夹具/新 CHECK 先全量扫描/大任务拆小）——协议卡/评审角色/模板文档面 | 🔄 | P3 | 高 | RM-AG0057 | 2026-09-03 | 2026-09-04 |
