...
|------|----------|------|------|--------|------|----------|----------|
| TAG0006 | agate UI/UX 验收质量机制：UX 需求/评审/验收（RM-0007）/ 视觉验收能力边界（RM-0004）/ GUI 框架评估（RM-0006）| 🔄 | P2 | 高 | — | 2026-08-13 | 2026-08-17 |
...
| TAG0012 | agate 协议机制增强批：阶段卡同类扫描（RM-AG0013）+ verification_env 边界 + 环境职责（RM-AG0014）+ P0-brief 时效验证（RM-AG0019）+ 运行时管控（RM-AG0023）| ⬜ | P0 | 高 | — | 2026-08-15 | 2026-08-17 |
| TAG0015 | agate 复盘与反馈机制统一（RM-AG0020 + RM-AG0021）：复盘模板进协议 + 正文结构/归因分层/事实依据 + orchestrator-log 扩展 + 会话 checkpoint + 跨项目反馈（结构化反馈节 + 匿名化 + 开关）| ⬜ | P0 | 高 | — | 2026-08-16 | 2026-08-16 |
