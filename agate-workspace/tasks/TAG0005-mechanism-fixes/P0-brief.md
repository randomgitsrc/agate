...
issues:
  ...
  - "RM-AG0011 check-gate P5 gate_commands 计数语义模糊：check-gate.sh L247-253，P5* 前缀命令全计入 P5 命令数，WARNING 'P2 声明了 N 个命令'。P2 声明 P5/P5_cli_remote/P5_serial 时计数 3，实际是'1 主+2 辅助'，误导主 Agent。修复=区分主/辅命令，WARNING 文案区分"
